...
| Duplication | Renderer duplication reduced (render-utils); widget header helper extracted; command parsing utils created (parseArgs) | No immediate duplication hotspots |
