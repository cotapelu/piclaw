// Quick test: Gọi skill_reader trực tiếp
import { createSkillLoaderTool } from './src/extensions/tools/skill-reader.js';
...
// Test 1: discovery mode (list skills)
...
// Test 2: get specific skill (debugger)
